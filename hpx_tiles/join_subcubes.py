...
def parse_args(argv):
    ...
    parser.add_argument('-f', dest='files', nargs='+', help='Files to join in frequency.', required=True)
    parser.add_argument('-o', dest='output', help='Output filename and path for joined fits file', required=True)
    parser.add_argument('-a', dest='axis', type=int, help='Frequency axis index in split fits files', default=1)
